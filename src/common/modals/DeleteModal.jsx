...
const DeleteModal = ({ open = false, setOpen = function(){}, title="", deleteEvent = function(){} }) => {
            ...
            >
                <div className="flex bg-white flex-col w-full">
                    ...
                    <div className="flex flex-col text-slate-700 justify-center items-center">
                        ...
                        <h2 className="text-lg font-poppins not-italic leading-normal my-2 font-semibold">{title !== "" ? title: "Do You Want to Delete This Campaign?"}</h2>
