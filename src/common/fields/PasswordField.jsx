...
const PasswordField = ({ control, errors, name, placeholder = "", className="", parentClass="", labelClass="", label = "", disabled=false }) => {
  ...
  return (
    <div className={"flex flex-col w-full gap-2" + (parentClass !== "" ? ` ${parentClass}`: "")}>
      ...
      <div className={`flex items-center border w-full border-solid border-[#6E6E6E] ${disabled ? "bg-[#6e6e6e34]": "bg-transparent"} overflow-hidden bg-transparent rounded-sm relative`}>
