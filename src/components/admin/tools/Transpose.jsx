...
import cif from "../../../assets/cif.png";
import { toastifyError } from "../../../constants/errors";

const Transpose = ({ open = false, setOpen = () => {} }) => {
    ...
    const startMerge = async () => {
        ...
        if(file1){
            ...
            setShowSpinner(true);
            try{
                const response = await axios.postForm("/tools/transposeColumnToRow", formData, {
                    responseType: 'blob'
                });
            ...
            >
                <div className="flex flex-col w-full">
                    <div className="flex p-3 justify-between bg-slate-800 text-white w-full items-center">
                        <h2 className="font-poppins not-italic leading-normal font-medium">Transpose Columns to Row</h2>
                    ...
                    <div className="bg-white flex flex-col py-5 px-2 gap-y-7 w-full">
                        <div className="flex justify-start gap-x-2 items-center">
                            ...
                            <img src={cif} alt="image" className="w-32 border border-solid border-slate-300 shadow-md shadow-slate-600" />
                        </div>

                        <Button className="bg-cyan-700 py-2 text-[16px] rounded-sm flex justify-center items-center w-full capitalize font-poppins not-italic leading-normal gap-x-2 font-medium" onClick={startMerge}>
