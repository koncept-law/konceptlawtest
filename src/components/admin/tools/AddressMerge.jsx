...
const AddressMerge = ({ open = false, setOpen = () => {} }) => {
    ...
    const startMerge = async () => {
        ...
        if(file1 && file2){
            ...
            //     responseType: 'blob'
            // });
            const response = await axios.postForm("/tools/addressMerger", formData, {
                responseType: 'blob'
            });
            ...
            >
                <div className="flex flex-col w-full">
                    <div className="flex p-3 justify-between bg-slate-800 text-white w-full items-center">
                        <h2 className="font-poppins not-italic leading-normal font-medium">Address Merge</h2>
                    ...
                    <div className="bg-white flex flex-col py-5 px-2 gap-y-7 w-full">
                        ...
                        <Button className="bg-orange-700 py-2 text-[16px] rounded-sm flex justify-center items-center w-full capitalize font-poppins not-italic leading-normal gap-x-2 font-medium" onClick={startMerge}>
